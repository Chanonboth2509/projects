...
// 2. นับ Node ออนไลน์ และจัดการสถิติแบตเตอรี่
$nodes_online = 0;
$nodes_total = 0;
...
if($res) {
    ...
    while($row = $res->fetch_assoc()) {
        if(strtolower($row['status']) == 'online') $nodes_online++;
