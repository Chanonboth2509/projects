...
// 2. อัปเดตสถานะอุปกรณ์ (Heartbeat & Battery)
...
// =============================================================
// 🟢 4. บันทึกเหตุการณ์ (Alerts) และกำหนดป้ายสีแจ้งเตือน
// =============================================================

// กำหนดประเภทเหตุการณ์ (Type) เริ่มต้นเป็น General (สีเทา)
$type = "General"; 

// 🔴 กลุ่ม SOS (ฉุกเฉินร้ายแรง - หน้าเว็บจะโชว์ป้ายสีแดง)
...
if (strpos($message, "อุบัติเหตุ") !== false) $type = "SOS"; // <-- คำใหม่
if (strpos($message, "รถชน") !== false) $type = "SOS"; // <-- คำใหม่
if (strpos($message, "น้ำท่วม") !== false) $type = "SOS"; // <-- คำใหม่
if (strpos($message, "สัตว์มีพิษ") !== false) $type = "SOS"; // <-- คำใหม่

// 🟡 กลุ่ม Security (ความปลอดภัย - หน้าเว็บจะโชว์ป้ายสีส้ม)
if (strpos($message, "โจร") !== false) $type = "Security";
if (strpos($message, "บุกรุก") !== false) $type = "Security";

// สร้างข้อความรายละเอียดเพิ่มเติม
$detail = "From: $node_id (Bat: $battery%, RSSI: $rssi dBm)";

// --- ป้องกันข้อมูลซ้ำ (Spam Protection) ---
